...
def get_params():
    ...
    # binarize data
    parser.add_argument("--vocab_path_en", type=str, default="dst_vocab/vocab.en", help="Path of vocabulary")
    parser.add_argument("--vocab_path_trans", type=str, default="", help="Path of vocabulary")

    parser.add_argument("--ontology_class_path", type=str, default="dst_data/ontology_classes.json", help="Path of ontology classes")
    parser.add_argument("--ontology_mapping_path", type=str, default="dst_data/ontology-mapping.json", help="Path of ontology mapping")
    ...
    parser.add_argument("--emb_file_en", type=str, default="dst_emb/embedding_en.npy", help="Path of pretrained embeddings in English")
    parser.add_argument("--emb_file_trans", type=str, default="dst_emb/embedding_de.npy", help="Path of pretrained embeddings in transfer language")
    parser.add_argument("--ontology_emb_file", type=str, default="dst_data/ontology_embeddings_en.npy", help="Path of ontology embedding file")
    ...
    parser.add_argument("--mapping_for_mix", type=str, default="dst_vocab/en2de_onto_for_mix.dict", help="mapping for mix language training")
