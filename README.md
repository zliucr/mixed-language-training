...
```
python main.py --exp_name dst_mlt_attn_de --bidirection --trans_lang de --mix_train --mapping_for_mix dst_vocab/en2de_attn_for_mix.dict --emb_file_en dst_emb/mix_embedding_en.attn.npy --emb_file_trans dst_emb/embedding_de.npy --ontology_emb_file dst_data/ontology_embeddings_de.npy --vocab_path_en dst_vocab/mix_vocab.attn.en --vocab_path_trans dst_vocab/vocab.de --weight_decay 1e-6
```
Zero-shot Adaptation for Italian
```
python main.py --exp_name dst_mlt_attn_it --bidirection --trans_lang it --mix_train --mapping_for_mix dst_vocab/en2it_attn_for_mix.dict --emb_file_en dst_emb/mix_embedding_en.attn.npy --emb_file_trans dst_emb/embedding_it.npy --ontology_emb_file dst_data/ontology_embeddings_it.npy --vocab_path_en dst_vocab/mix_vocab.attn.en --vocab_path_trans dst_vocab/vocab.it --weight_decay 1e-6
```

### NLU Task
Zero-shot Adaptation for Spanish
```
python main.py --exp_name nlu_mlt_attn_es --run_nlu --mix_train --bidirection --trans_lang es --batch_size 64 --emb_file_en nlu_emb/mix_embedding_en.attn.npy --emb_file_trans nlu_emb/embedding_es.npy --vocab_path_en nlu_vocab/mix_vocab.attn.en --vocab_path_trans nlu_vocab/vocab.es --mapping_for_mix nlu_vocab/en2es_20.attn.dict
```
Zero-shot Adaptation for Thai
```
python main.py --exp_name nlu_mlt_attn_th --run_nlu --mix_train --bidirection --trans_lang th --batch_size 64 --emb_file_en nlu_emb/mix_embedding_en.attn.clean.npy --emb_file_trans nlu_emb/embedding_th.clean.npy --vocab_path_en nlu_vocab/mix_vocab.attn.clean.en --vocab_path_trans nlu_vocab/vocab.clean.th --mapping_for_mix nlu_vocab/en2th_20.attn.dict --clean_txt
```
